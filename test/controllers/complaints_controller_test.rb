...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { conpany_id: @complaint.conpany_id, content: @complaint.content, user_id: @complaint.user_id } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { conpany_id: @complaint.conpany_id, content: @complaint.content, user_id: @complaint.user_id } }
